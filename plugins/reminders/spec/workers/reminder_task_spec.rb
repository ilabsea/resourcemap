...
describe ReminderTask do
  let!(:users) { [User.make(:email => 'user@instedd.org', :password => 'abCdEf123!', :phone_number => '855123456789'), 
    User.make(:email => 'demo@instedd.org', :password => 'abCdEf123', :phone_number => '855123333444')]}
